...
timeStep = 180     #Time step of simulation in seconds
earthSun = solarSystem(b)

for planet in earthSun.planets:    #Add all particle class objects to a list
        xDict[planet.Name] = []     #Each planet has an empty list indexed to its name for both x and y coordinates
        yDict[planet.Name] = []
        
earthSun.livePlot(180,5000000,100,0.0005)
